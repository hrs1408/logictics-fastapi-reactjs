      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-2 items-center about">
          <div className="left-about z-10 text-center p-[20px]">
            ...
            <p className="summary text-white tracking-[-0.02rem] mt-[0.5rem] pr-[4rem] mb-[3rem]">
              ...
              <br />
              như dịch vụ Chuyển phát Nhanh, Chuyển phát Quốc tế, Chuyển phát
              Thu hộ (COD), Cho thuê Kho bãi, Hoàn thiện đơn hàng... với văn hóa
              phục vụ
              <br />
            ...
            <Link
              className="hover:text-[#fcd804] mt-10 m-auto flex items-center gap-2 justify-center w-[189px] h-[38px] bg-[#FFFFFF] rounded-[4px] leading-[34px]  "
              to={'/'}
            >
              Gửi hàng ngay
          ...
          <div className="">
            <ul>
              <li className="mt-[20px] pb-[15px] pl-[3rem]">
                <div className="flex gap-5">
                  <span className="about-icon">
                    <FaShippingFast className="text-[#2F302F] " />
                  </span>
                  <div className="">
                    <div className="title-about text-[24px] font-bold text-[#2F302F] ">
                      Giao hàng hỏa tốc
                    </div>
              ...
              <li className="mt-[20px] pb-[15px] pl-[3rem]">
                <div className="flex gap-5">
                  <span className="about-icon">
                    <TbCalendarTime className="text-[#2F302F] " />
                  </span>
                  <div className="">
                    <div className="title-about text-[24px] font-bold text-[#2F302F] ">
              ...
              <li className="mt-[20px] pb-[15px] pl-[3rem]">
                <div className="flex gap-5">
                  <span className="about-icon">
                    <RiLuggageCartLine className="text-[#2F302F] " />
                  </span>
                  <div className="">
                    <div className="title-about text-[24px] font-bold text-[#2F302F] ">
                    ...
                    <span className="text-[17px]">
                      ...
                      <br />
                      Mạng lưới 400 bưu cục và điểm nhận trả hàng phủ sóng toàn
                      quốc
                    </span>
                  </div>
                </div>
              ...
              <li className="mt-[20px] pb-[15px] pl-[3rem]">
                <div className="flex gap-5">
                  <span className="about-icon">
                    <BsShieldFillCheck className="text-[#2F302F] " />
                  </span>
                  <div className="">
                    <div className="title-about text-[24px] font-bold text-[#2F302F] ">
                      Đảm bảo an toàn
              ...
              <li className="mt-[20px] pb-[15px] pl-[3rem]">
                <div className="flex gap-5">
                  <span className="about-icon">
                    <BiSupport className="text-[#2F302F] " />
                  </span>
                  <div className="">
                    <div className="title-about text-[24px] font-bold text-[#2F302F] ">
                      Hỗ trợ trực tuyến
                    ...
                    <span className="text-[17px]">
                      ...
                      <br />
                      Liên hệ với chúng tôi qua: Hotline, Facebook Messenger,
                      Website Live Chat, Zalo Chat hoặc Email
                    </span>
                  </div>
                </div>
              </li>
