...
from schemas.user_schemas import UserInformation, UserSchemas, UserInternalInfor
...
@users.put("/users/information", response_model=ResponseSchema[UserInformation])
