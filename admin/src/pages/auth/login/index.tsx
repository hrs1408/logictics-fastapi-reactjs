...
const Login = () => {
  ...
  return (
    <div className={'login-wrapper w-full h-screen'}>
      <div
        className={
          'login-form w-[370px] md:w-[500px] bg-white p-4 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow rounded-xl'
        }
      >
        ...
        <form onSubmit={handleSubmit(handleLogin)}>
          <div className={'input-group py-1 flex flex-col'}>
            <label htmlFor="username" className={'font-bold pb-2'}>
              Email
            </label>
            <input
              {...register('email')}
              ...
              id={'email'}
              className={
                'border border-2 p-2 rounded outline-none focus:border-b-yellow-500 transition'
              }
            />
          ...
          <div className={'flex justify-between py-2'}>
            <div className={'flex items-center'}>
              ...
              <label
                htmlFor="remember"
                className={'font-semibold text-[14px] pl-2'}
              >
                Remember me
              </label>
            </div>
          ...
          <div className={'input-group py-1 flex flex-col'}>
            <button
              type={'submit'}
              className={
                'bg-yellow-500 text-white p-2 rounded mt-4 hover:opacity-80 transition'
              }
            >
              Login
            </button>
