...
import {Divider, ListItemText, Menu, MenuItem, MenuList, Modal} from '@mui/material'
import {
    useDeleteInvoice,
...
const EnhancedInvoiceTable: React.FC<ListInvoice> = ({listInvoice}) => {
    ...
    return (
        <Box sx={{width: '100%'}}>
            <ModalInvoice invoice={invoiceView} open={open} onClose={() => setOpen(false)}/>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell
                                                ...
                                                scope="row"
                                                padding="none"
                                                onClick={event => handleClickInvoice(row)}
                                            >
                                                {row.senderFullName}
                                            </TableCell>
